...
logger = logging.getLogger("legalaid.contradiction")
...
def detect_contradictions(
    ...
    """
    try:
        # Coerce facts list safely
        facts = relevant_facts if isinstance(relevant_facts, list) else []
        contradictions: List[Contradiction] = []
        combined_text = " ".join(facts)
        ...
        logger.error("Unexpected error in detect_contradictions: %s", e)
